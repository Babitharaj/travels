...
export default function LoginModal(props) {
 ...
 return(
  ...
  <div className={styles.backdrop}>
      <div className={styles.modalBody} style={{backgroundImage:`url(${formModal?.formContent?.formBg?.value})`}}>        
    <div className={styles["form-wrap"]}>
    <button onClick={() => setIsVisible(false)}>&times;</button>

    <div className={styles["form-main"]}> 
    <div className={styles["heading"] + " d-lg-none"}>
      <p className={styles["leading"]}><span style={{fontSize:"16px"}}>{formModal?.formContent?.heading?.value}</span></p>
     <p className={styles["sub"]}>
     {formModal?.formContent?.subHeading?.value}&nbsp;
    </p>
    </div>
    ...
    <div className="input_section">
           ...
           <div id={styles["newdiv"]}>
             ...
             <label>
             {formModal?.formContent?.declarationText?.value}
             </label>
           </div>
           <div className={styles["buttonCenter"]}>
             <input
               ...
               type="submit"
               value={formModal?.formContent?.btnText?.value}
             />
           </div>
